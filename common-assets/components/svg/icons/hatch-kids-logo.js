export default (
    <>
        ...
        <path
            d="M60.644 25.845c0-6.229 6.024-7.541 14.31-7.818 3.114-.104 5.054 3.242 3.474 5.873l-.37.617c-1.366 2.273-.597 5.132 1.063 7.2C80.94 33.984 82 36.876 82 40.838c0 7.103-7.402 7.247-19.92 7.144-3.032-.025-4.983-3.195-3.573-5.823l3.122-5.818c.942-1.755.653-3.868-.095-5.713-.563-1.389-.89-2.977-.89-4.784z"
            fill="#DD6814"
        />
        <mask
            id="10bt5pw8ea"
            ...
            height="30">
            <path
                d="M60.644 25.845c0-6.229 6.024-7.541 14.31-7.818 3.114-.104 5.054 3.242 3.474 5.873l-.91 1.514c-1.068 1.778-.491 4.011.933 5.531C80.68 33.324 82 36.413 82 40.84c0 7.103-7.402 7.247-19.92 7.144-3.032-.025-4.983-3.195-3.573-5.823l3.469-6.464c.733-1.367.526-3.003-.147-4.4-.742-1.54-1.185-3.347-1.185-5.451z"
                fill="#DD6814"
            />
        </mask>
        <g filter="url(#od863fq38b)" mask="url(#10bt5pw8ea)">
            <path
                d="M60.644 25.845c0-6.229 6.024-7.541 14.31-7.818 3.114-.104 5.054 3.242 3.474 5.873l-.91 1.514c-.86 1.432-4.412 4.906-3.577 6.744 1.612 3.551 8.051 2.762 8.051 9.076-.798 6.749-7.63 6.85-19.913 6.749-3.03-.025-4.982-3.195-3.572-5.823 1.49-2.624 9.39-1.321 10.599-2.9 1.208-1.578-5.669-4.143-7.13-7.638a6.8 6.8 0 0 0-.147-.326c-.742-1.54-1.185-3.347-1.185-5.451z"
                fill="#DD6814"
            />
        </g>
        <path
            d="M.604 43.889V22.006c0-2.239 1.805-4.053 4.03-4.053h9.932c3.417 0 5.283 4.007 3.096 6.647l-2.407 2.904a4.07 4.07 0 0 0 .012 5.203l7.169 8.574c2.204 2.636.34 6.66-3.084 6.66H4.634c-2.225 0-4.03-1.814-4.03-4.052z"
            fill="#187BEF"
        />
        <mask
            id="g24x1punnc"
        ...
        <g filter="url(#3kjd8q58rd)" mask="url(#g24x1punnc)">
            <path
                d="M.605 43.889V22.006c0-2.239 1.804-4.053 4.03-4.053h9.932c3.416 0 5.283 4.007 3.096 6.647l-2.407 2.904C14.038 28.974 2.216 38.418.605 43.89c0 .926-.365 2.107-.254 1.188.042-.355.125-.75.254-1.188z"
                fill="#187BEF"
            />
        </g>
        <path
            d="M23.976 22.006v21.883c0 2.238 1.804 4.052 4.03 4.052h2.417c2.225 0 4.03-1.814 4.03-4.052V22.006c0-2.239-1.805-4.053-4.03-4.053h-2.418c-2.225 0-4.03 1.814-4.03 4.053z"
            fill="#4FD9B8"
        />
        <mask
            id="hse2hs7hve"
        ...
        <mask
            ...
            height="31">
            <path
                d="M36.063 42.941V22.953a5 5 0 0 1 5-5h2.253c6.85 0 12.492 4.863 14.104 13.778 1.611 8.916-2.418 16.21-10.88 16.21h-5.479a4.998 4.998 0 0 1-4.998-5z"
                fill="#F0B41A"
            />
        </mask>
        <g filter="url(#tlazehrgmh)" mask="url(#z5au2j5p4g)">
            <path
                d="M36.063 22.006v21.883c0 2.238 1.804 4.052 4.03 4.052h4.835V22.006c0-4.053 0-4.053-4.03-4.053h-.805c-2.226 0-4.03 1.814-4.03 4.053z"
                fill="#F8BA1C"
            />
        </g>
        <defs>
